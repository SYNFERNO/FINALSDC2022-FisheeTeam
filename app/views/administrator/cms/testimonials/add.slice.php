...
<div class="page-inner">
    ...
    <div class="card">
        ...
        <!--begin::Form-->
        <form method="POST" action="{{$PAGE_URL.'add_Survey'}}">
            {{ csrf_token() }}
            <div class="card-body">
                <div class="form-group row ">
                    <div class="col-lg-6">
                        <label >Nama</label>
                        <input type="text" class="form-control {{error_form_class('name')}}" value="" name="name" placeholder="Nama">
                        <div class="error text-danger">{{error_form('name') ?? ''}}</div>
                    </div>
                    <div class="col-lg-6">
                        <label >Umur</label>
                ...
                <div class="form-group row ">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input name="image" class="form-control {{error_form_class('datetime')}}" id="image"  type="file">
